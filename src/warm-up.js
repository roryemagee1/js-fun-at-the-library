...
var sequel = title + " II: Electric Boogaloo"
console.log(sequel);
...
console.log(isShortStory(pages));
...
var books = ['Go Dog, Go!', 'The Cat in the Hat', 'Do you Like Green Eggs and Ham?', 'Where the Wild Things are', 'Rory the Lion'];
...
var belowTwoHundred = [17, 2, 68, 54, 91, 45, 33, 71, 88, 26, 188, 154];
